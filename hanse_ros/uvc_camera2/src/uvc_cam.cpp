  ...
  width(_width), height(_height), fps(_fps), rgb_frame(NULL)
{
  ...
  try
  {
    ...
    //set_control(10094851, 0); // Exposure, Auto Priority 1
    //set_control(10094849, 0); // Exposure, Auto 1
    ...
    set_control(9963776, 0); //Brightness 128
    set_control(9963777, 32); //Contrast
    set_control(9963788, 1); // White Balance Temperature, Auto 1
    /*set_control(9963802, 5984); // White Balance Temperature
    set_control(9963800, 2);  // power line frequency to 60 hz
    set_control(9963795, 100); // Gain 200
    set_control(9963803, 7); // Sharpness 224*/
    set_control(9963804, 1); //Backlight Compensation 1
